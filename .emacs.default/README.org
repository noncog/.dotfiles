#+TITLE:Emacs Config
#+STARTUP: hideblocks
These are my dotfiles for vanilla emacs. I use Chemacs 2 to load both vanilla and doom emacs. Thus, this directory is not the default one. That one is now inhabited by chemacs2.
