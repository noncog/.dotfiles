...
This function uses the above hack to Magit for editing dotfiles in a bare repository to select one and edit it.

- TODO: Get Marginalia support.
...
This section holds code that has been removed with an explanation why if I feel the need to keep it for posterity or for others to learn from/use.
