...
Here, we can use Xresources to define host specific settings and include them into the i3 configuration.
...
#+begin_src conf :tangle Europa.conf
set $laptop eDP-1
set $external HDMI-1-0
#+end_src

#+begin_src conf :tangle Callisto.conf
set $external DP-0
#+end_src
...
for_window [class="GT: New Horizons 2.6.1|Enigmatica 2: Expert"] move scratchpad, sticky enable
#+end_src

#+begin_src conf :tangle config :noweb-ref keybinds
bindsym $mod+p [class="GT: New Horizons 2.6.1|Enigmatica 2: Expert" tiling] move scratchpad, scratchpad show, $gregtech-size; [class="GT: New Horizons 2.6.1|Enigmatica 2: Expert" floating] scratchpad show, $gregtech-size
bindsym $mod+Shift+p exec --no-startup-id /opt/PrismLauncher/bin/prismlauncher -l "GT_New_Horizons_2.6.1_Java_17-21"
bindsym $mod+Control+p [class="GT: New Horizons 2.6.1|Enigmatica 2: Expert" tiling] move scratchpad, scratchpad show; [class="GT: New Horizons 2.6.1|Enigmatica 2: Expert" floating] scratchpad show, floating toggle
#+end_src
