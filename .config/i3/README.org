...
* Basic Controls
Mostly standard, with some improvements.
#+BEGIN_SRC conf
# set mod key
set $mod Mod4
...
** Kitty
=NOTE= - To use i3-sensible-terminal, you have to set $TERMINAL environment variable.
#+BEGIN_SRC conf
for_window [class="kitty"] floating enable, resize set 50 ppt 50 ppt, move scratchpad, sticky enable
...
for_window [instance="Ranger-Float"] floating enable, resize shrink 50 ppt, move scratchpad, sticky enable
