...
for_window [class="GT: New Horizons 2.5.1"] move scratchpad, sticky enable
#+end_src

#+begin_src conf :tangle config :noweb-ref keybinds
bindsym $mod+p [class="GT: New Horizons 2.5.1" tiling] move scratchpad, scratchpad show, $gregtech-size; [class="GT: New Horizons 2.5.1" floating] scratchpad show, $gregtech-size
bindsym $mod+Shift+p exec --no-startup-id /opt/PrismLauncher-Linux-Qt5-8.2/bin/prismlauncher -l "GT_New_Horizons_2.5.1_Java_17-21"
bindsym $mod+Control+p [class="GT: New Horizons 2.5.1" tiling] move scratchpad, scratchpad show; [class="GT: New Horizons 2.5.1" floating] scratchpad show, floating toggle
#+end_src
