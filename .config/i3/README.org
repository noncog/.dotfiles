...
bindsym $mod+Shift+f exec --no-startup-id firefox -profile $HOME/.config/firefox/noncog
...
bindsym $mod+Escape exec --no-startup-id rofi -show drun -show-icons
# cogmenu - custom menu launcher
bindsym $mod+BackSpace exec --no-startup-id $HOME/.config/rofi/cogmenu/cogmenu.sh
#+end_src
