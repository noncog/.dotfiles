...
bindsym $mod+Control+minus resize shrink width 10 px or 10 ppt
bindsym $mod+Control+equal resize grow width 10 px or 10 ppt

# vertically
bindsym $mod+Shift+minus resize shrink height 10 px or 10 ppt
bindsym $mod+Shift+equal resize grow height 10 px or 10 ppt

bindsym $mod+Control+Shift+minus resize shrink height 10 px or 10 ppt
bindsym $mod+Control+Shift+equal resize grow height 10 px or 10 ppt
#+end_src
...
*** GIMP
#+begin_src conf
for_window [title="GNU Image Manipulation Program"] mark gimp

assign [con_mark=gimp] $gimp
bindsym $mod+Shift+g exec --no-startup-id gimp
bindsym $mod+g [con_mark=gimp] focus
#+end_src
...
#+begin_src conf
# emacs
exec --no-startup-id sleep 3 && emacs
