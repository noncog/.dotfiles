...
I use relative line numbers with Vim navigation for numbered line jumping. Visual gives the true relative line numbers for the document for more accurate jumping.
...
Considering refactoring this section.
...
TODO set this up for org-present, not global.

I use this to add spacing to the top of org documents during presentations. By default, this is inherited from the modeline, which is colored, and I need it to be transparent.
