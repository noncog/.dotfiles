...
I put the additional packages here instead of in their package configurations so I can easily see and manage the packages I've added to Doom.
...
** TODO Package Configuration in Doom
...
** TODO On Doom Macros and Variables
...
#+begin_src emacs-lisp :tangle (if (file-exists-p "~/Documents/org/") "no" "packages.el")
...
TODO: I need to find a fix for these, neither work correctly. I believe that it has something to do with unexpanded directory names and regular expressions.
...
I have to force Projectile to constantly remove ignored files and directories when entering and leaving. Otherwise, it won't ignore what it should.

#+begin_src emacs-lisp :tangle no :noweb-ref projectile-hook
...
Currently not modifying the backends. This may change...
