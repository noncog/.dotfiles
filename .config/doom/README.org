...
A global leader bind to exit org-noter.
...
I had issues with Doom and org-noter not closing pdf buffers and returning my windowing back to normal. This function solves that and I call it with a keybind to exit the session.
...
This wonderful package blinks the cursor line and allows recentering. I primarily use it on window switching to never lose track of the cursor/point again.
