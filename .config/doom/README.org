...
This section is for "global" or top-level configuration. Outside of this section, each section is dedicated to configuring specific packages.

** Resources

Emacs and Doom Emacs (Linux in general) configuration is somewhat of an art. Here are a few user configurations to learn from.
...
=init.el=
#+html:<details><summary>Defines which of Doom's modules are loaded.</summary>
...
=packages.el=
#+html:<details><summary>Defines which external pacakges are loaded.</summary>
...
=config.el=
#+html:<details><summary>The user's custom configuration.</summary>
...
#+begin_quote
[[https://github.com/Malabarba/beacon][Beacon]] is a minor mode that highlights the current line after jumping around.
#+end_quote
...
I use this to center org-mode buffers primarily. In Doom, I get this package by enabling the wordwrap or zen module.
