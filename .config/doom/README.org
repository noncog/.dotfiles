...
#+begin_src emacs-lisp :tangle no :noweb-ref beacon-init :exports none
;; Appearance
#+end_src
...
#+begin_src emacs-lisp :tangle no :noweb-ref doom-dashboard-config :exports none
;; Appearance
#+end_src

*** Remove Footer

#+begin_src emacs-lisp :tangle no :noweb-ref pre-doom-dashboard
...
#+begin_src emacs-lisp :tangle no :noweb-ref pre-magit
...
*** Integrate Org-Roam into Agenda Files
...
#+begin_src emacs-lisp :tangle no :noweb-ref post-org-agenda :exports none
;; Keybinds
#+end_src
...
Note: This is being sent to org's config.
