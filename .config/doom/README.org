...
I was having an issue using =emacsclient= where which-key was being cut off below the modeline. A simple solution is to add spaces below the keybinds. Realistically, this doesn't work everywhere but it's good enough for now. ([[https://github.com/justbur/emacs-which-key/issues/231#issuecomment-627503184][Source]])
