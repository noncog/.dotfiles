...
*** Testing Fixing Treemacs Issues

https://github.com/Alexander-Miller/treemacs#tag-view

#+begin_src emacs-lisp :tangle no :noweb-ref pre-treemacs
...
treemacs-elisp-imenu-expression
imenu-generic-expression
imenu-syntax-alist
*** Don't Add All New Projects to Each Workspace
