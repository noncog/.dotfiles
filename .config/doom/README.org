...
**** Custom Functions
***** My Agenda Launcher
Just a wrapper function I can bind a keybind to or call by itself to launch my agenda.
#+begin_src emacs-lisp
...
***** Frame Control
Prevent noter from doing odd things to my Emacs...
#+begin_src emacs-lisp :tangle no :noweb-ref use-package-org-noter-config
...
These functions allow me to advance through the headings, folding previous ones and only showing the current heading's information tidily.
#+begin_src emacs-lisp
...
Here any formatting is done upon entering and exiting the presentation mode.
#+begin_src emacs-lisp
