...
**** Custom Faces
***** Header-Line
I use this to add spacing to the top of org documents for presentations. By default, this is inherited from the modeline, which is colored, and I need it to be transparent.
#+begin_src emacs-lisp
(custom-set-faces!
...
***** Cursor color
This syntax allows me to choose any of the Dracula colors defined in my theme as my new cursor color.
#+begin_src emacs-lisp
(custom-set-faces!
...
I do this for any modes I would like to setup my own keybinds for, instead of using evil's default mode binds.
#+begin_src emacs-lisp
...
**** Keybinds
I set my own keybinds for this mode, as the default and evil's really made no sense.
#+begin_src emacs-lisp :tangle no :noweb-ref use-package-org-present-config
...
#+end_src
** Org-Plot
[[https://orgmode.org/manual/Org-Plot.html][Org-plot]] produces 2D/3D graphs from org tables.
*** Appearance
