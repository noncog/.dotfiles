...
I define a function to call my agenda either from the M-x or through a keybind.
...
Text-mode is often inherited by other modes like org-mode. I would rather be able to control modes explicitly instead of use inheritance. Default inheritance pattern: text-mode > outline-mode > org-mode.

****** Disable text-mode Global Setup

#+begin_src emacs-lisp :tangle no :noweb-ref use-package-company-config
(setq company-global-modes '(not text-mode erc-mode circe-mode message-mode help-mode gud-mode vterm-mode))
#+end_src

****** Remove text-mode Backend
...
This package adds centering to buffers!
...
#+begin_src emacs-lisp :tangle no :exports none :noweb-ref use-package-python
(use-package! python
#+end_src
