:PROPERTIES:
:ID:       d9e2bc97-ec0a-48c6-8151-c6c6e88eae7c
:END:
...
- [[#applescript][Applescript]]
  - [[#package-40][Package]]
  - [[#enable-editing-of-compiled-script-files][Enable Editing of Compiled Script Files]]
...
#+begin_src emacs-lisp :tangle no :noweb-ref doom-modeline-init
(setq doom-modeline-persp-name t
      doom-modeline-display-default-persp-name t
      doom-modeline-persp-icon t)
#+end_src
...
I did this by rewriting =doom-modeline-buffer-file-name= to get the buffer file name from the following functions that I've written to decide whether or not the file name should be formatted or not.
...
After setting up the correct file names, we can take advantage of Doom Modeline's file name rendering settings.
...
**** Ensure "DATE" Property for New Nodes Using Denote
:PROPERTIES:
:DATE:     20230928T212105
:END:
...
*** Ensure Links are Store When Capturing from Websites
...
#+begin_quote
(WIP) This section is setup to enable extending Emacs using Applescript. This section is highly experimental and does not follow my normal package configuration conventions.
#+end_quote

** Package

#+html:<details><summary>Tangle Header to config.el</summary>
#+begin_src emacs-lisp :tangle no :noweb-ref config :noweb yes :noweb-sep "\n\n"
<<applescript-config>>
#+end_src
#+html:</details>

** Enable Editing of Compiled Script Files

([[https://www.emacswiki.org/emacs/AppleScript][Source]])

#+begin_src emacs-lisp :tangle no :noweb-ref applescript-config
