...
#+RESULTS:
: ((ISSUE . +org-todo-project) (NEXT . +org-todo-active) (WAIT . +org-todo-onhold) (KILL . +org-todo-cancel) (NOTE . +org-todo-active) (LINK . +org-todo-active) (QUESTION . +org-todo-active))
...
- NOTE: Currently disabled due to various issues.
- TODO: Develop or use better insert here headings.
  - I'll need to write a function which better targets the current heading and creates an entry instead of plain text.
...
Then, we hide capture or make certain capture templates only available in certain modes. For me, Some of these templates are only called after I have pre-processed some information such as interactively obtaining a value for the template. Therefore, I don't want them to break or be used unless it's ready to be used.

- TODO: Needs work, fix this.

#+begin_src emacs-lisp :tangle no :noweb-ref org-capture-config-disabled :results none
(setq org-capture-templates-contexts
      '(("s" ((in-mode . "my/org-capture-mode")))))
#+end_src
...
(setq org-bookmark-location-handlers '((org-bookmark-handler-file-heading "node/20240123T062105--bash.org" "Bookmarks")
                                       (org-bookmark-handler-file-heading "inbox.org" "Bookmarks")))
#+end_src
