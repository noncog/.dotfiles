:PROPERTIES:
:header-args:bash: :eval no :noweb-sep "\n\n"
:END:
#+title: Envi
...
=Envi= is a cross-platform single-file utility script written in Bash to help automate setup and maintenance of the system.

The goal of Envi is to support:

- Setup of programs, fonts, and settings.
- Easy interaction with services and the environment.
- CLI and TUI usage.
...
#+begin_src bash :noweb-ref file-header
#===============================================================================#
#        file: envi                                                             #
...
#+begin_src bash :noweb-ref fail-fast-checks
# Fail fast checks.
...
#+begin_src bash :noweb-ref initial-setup
# Initial setup.
...
This section should hold functions specific to envi and not a general library.

** Build

#+begin_src bash :tangle envi :noweb yes :shebang #!/bin/env bash
<<file-header>>
...
#+begin_src bash :noweb-ref lib-regex
#===============================================================================#
...
#+begin_src bash :noweb-ref lib-terminal :noweb yes
#===============================================================================#
# >>> Terminal Library.                                                         #
#===============================================================================#
#+end_src
...
#+begin_src bash :noweb-ref lib-terminal
#====================================================================#
...
#+begin_src bash :noweb-ref lib-log
#===============================================================================#
# >>> Logging Library.                                                          #
#===============================================================================#
#+end_src
...
- [ ] Add redirection to output streams.
...
#+begin_src bash :noweb-ref lib-ui
#===============================================================================#
...
- [ ] Consider adding bounds checking or a warning.
...
- [ ] Consider adding info logging.
- [ ] Consider adding location argument to specify screen location.
- [ ] Consider adding support for specific outputs.
- [ ] Consider adding timeout after x count.
- [ ] Consider adding question modification after x failures.
- [ ] Consider adding support for alternate buffer.
- [ ] Add comments.
- [ ] Consider separating processing of read results into another function.
- [ ] Add support for escape and enter handling?
- [ ] Add separate input processing function?
...
#+begin_src bash :noweb-ref lib-trap
#===============================================================================#
# >>> Trap Library.                                                             #
#===============================================================================#
#+end_src
...
#+begin_src bash :noweb-ref lib-system
#===============================================================================#
# >>> System Library.                                                           #
#===============================================================================#
#+end_src
...
#+begin_src bash :noweb-ref lib-file
#===============================================================================#
# >>> File Library.                                                             #
#===============================================================================#
#+end_src
...
#+begin_src bash :noweb-ref lib-helper
#===============================================================================#
...
Omarchy has a method which uses fc-list and some options and filtering to return a nicely formatted list of font names.
- Consider moving to font::file_exists and font::cache_exists or font::exists_file and font::exists_cache
...
~/dev/source/dorothy/commands/get-app

#+begin_src bash :tangle no
# TODO Header comment.
# TODO Implement from Dorothy.
...
#+begin_src bash :tangle no
# TODO: Header comment.
# TODO: Re-engineer from Dorothy.
# TODO: Consider wrapping in OS detection since platform dependent.
function app_exists() {
    :
}
#+end_src
...
#+begin_src bash :tangle no
# TODO: Execute a command logging its output somewhere.
function run::logged() {
    :
}
#+end_src
...
- Whenever associative arrays are not available there may be work-arounds using other means of data encoding.
  - Arrays can hold variable names. Then we can use an array like an object. This can be used for packages, modules, etc.

#+begin_src bash :eval no
# The following can be used similar to Doom Emacs' modules function to allow enabling/disabling.
...
- To enable more capability we could forego strictly using Bash.
  - The script could be interpreted under sh and perform basic detection acquiring Bash or Emacs first and then executing a section under that interpreter.

** Tasks

#+begin_src bash :eval no
# TODO: See if linutil's use/setup of $PATH and Flatpak works and why.
# TODO: Decide if argument count checks should use arithmetic comparison or test flags.
# TODO: Decide on incorrect argument count error message and return value (number).
# TODO: Decide how variables should be used in Bash as true/false in if statements.
#      - Sometimes can fail or have odd consequences with certain values (un[safe|predictable]).
# TODO: Add conversion between forms: dec, hex, oct, asci, ansi, etc.
# TODO: Add checking if a package is a brew package and if the one found on the path is the one from brew.
# TODO: Develop testing setup.
#+end_src
