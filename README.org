...
Otherwise, to just install dotfiles managed with a bare repository on a fresh system see the cloning section below!
* Short Setup Guide
...
If this is the case use the following cloning script:
...
#+END_SRC
Again, this script is part of my [[https://github.com/noncog/debian-autosetup][debian-autosetup]] script, which may be easier to use to setup your software and clone your dotfiles managed with git --bare.
