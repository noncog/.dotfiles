...
Otherwise, to just install dotfiles (like these)  managed with a bare repository on a fresh system see the cloning section below!
* Short Setup Guide
...
#+BEGIN_SRC
  ...
  # assumes that you back up your .bashrc with the permanent alias,
