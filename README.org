...
#+END_SRC
Again, this script is part of my [[https://github.com/noncog/debian-autosetup][debian-autosetup]] script, which may be easier for you to use to setup your software and clone dotfiles managed with git --bare.
