...
#+END_SRC
* Cloning
To get your configurations (or these) on a fresh system, you simply clone the bare repository and they're automatically installed!
** Simple Clone
#+BEGIN_SRC
...
- WARNING: If used as is, this will backup your dotfiles and replace them with mine. Change the repository for your own use, or fork/customize my [[https://github.com/noncog/debian-autosetup][debian-autosetup]] for your needs.
...
#+END_SRC
Again, this script is part of my [[https://github.com/noncog/debian-autosetup][debian-autosetup]] script, which may be easier for you to use to setup your software and clone your dotfiles managed with git --bare.
