...
#+HTML:<li>
#+HTML:<details>
#+HTML:<summary><code>rofi-chemacs</code> - My custom Emacs <a href="https://github.com/noncog/rofi-chemacs">menu</a>.</summary>
...
#+HTML: <details><summary><b>Keybinds</b></summary><p>I prefer tools that enable me to control everything primarily with the keyboard.<br>Will be adding keybinds table soon...</p></details>
